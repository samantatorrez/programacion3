...
public class Main {
	...
	// Tarda menos porque en el peor de los casos tiene que insertar en el final (recorre menos)
	...
	// Tarda mas porque tiene que insertar hasta el final siempre
	...
	public static void main(String[] args) {
		...
		// LISTAS DESORDENADAS
		ListaSimple lista1= new ListaSimple(500);
        System.out.println(">Lista desordenada 1");
        //lista1.print();
        ListaSimple lista2= new ListaSimple(500);
        ...
        ListaOrdenada lista4= new ListaOrdenada(500);
        //lista4.print();
        System.out.println(">Lista ordenada 5");
        ListaOrdenada lista5= new ListaOrdenada(500);
        //lista5.print();
